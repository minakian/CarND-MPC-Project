      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
          ...
          */
          ...
          // Calcualte the cars state and actuators after latency
          ...
          auto t_points = Eigen::MatrixXd(2,len);
          ...
          Eigen::VectorXd ptsx_transform = t_points.row(0);
          Eigen::VectorXd ptsy_transform = t_points.row(1);
